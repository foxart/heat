...
$imageSiteFilename = PATH_CACHE . $get_link . '.jpg';
$imageTrackFilename = PATH_CACHE . "{$get_link}_site_moves.jpg";
...
$imageTrack->load($imageSiteFilename);
...
foreach ($heatDataRed as $key => $value) {
	...
	$imageTrack->draw_point_gradient($positionX, $positionY, $radiusRed, $colorBlue, 0x00, 0xFF, $stepRed, true);
};
...
foreach ($heatDataYellow as $key => $value) {
	...
	$imageTrack->draw_point_gradient($positionX, $positionY, $radiusYellow, $colorYellow, 0x00, 0xFF, $stepYellow, true);
};
...
$imageTrack->save($imageTrackFilename, 'jpg', 80);
