...
//		$watch_href = 'http://' . DOMAIN . US . 'live' . US . 'watch' . "?statistic={$value['id']}";
		...
		switch ($value['action']) {
			case 'exit':
				$view = "<img src='/heat/theme/default/image/icons/user.exit.png'/>";
				$chat = "<img src='/heat/theme/default/image/icons/user.exit.png'/>";
				break;
			default:
				$view = "<a class=\"_blank\" href=\"{$watch_href}\"><img src='/heat/theme/default/image/icons/user.watch.png'/></a>";
				$chat = "<img src='heat/theme/default/image/icons/user.exit.png'/>";
				break;
		}
...
//		$tableRows[$key]['user'] = $user_title;
		...
		$tableRows[$key]['view'] = $view;
//		$tableRows[$key]['chat'] = "<a class=\"_blank\" href=\"{$chat_href}\"><img src='/heat/theme/default/image/icons/user.chat.png'/></a>";
		$tableRows[$key]['chat'] = "<a class=\"_blank\" href=\"{$watch_href}\"><img src='/heat/theme/default/image/icons/user.chat.png'/></a>";
